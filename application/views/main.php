  ...
  <div class="banner-item">
          ...
          <div class="container clearfix">
            ...
            <div class="banner-caption text-center mt-4">
              ...
              <a href="<?php echo PLAYSTORE ?>" title="" target="_blank" class="btn btn-primary btn-lg">Download Now <img style="height: 32px;" src="<?php echo base_url()?>/uploads/icons/google.png"></i></a>
            </div>
          </div>
        </div>
      </div>
