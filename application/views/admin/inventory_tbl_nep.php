              ...
              <section class="panel">
                  <header class="panel-heading">
                     ...
                     <span class="tools pull-right">
                       ...
                       <a href="<?php echo base_url()?>upload_csv_invent?cat=<?php echo $cat ?>&&lang=nep"><button type="submit" name="upload_data" class="btn btn-danger" style="background-color: #1fb5ad;border-color: #1fb5ad;margin-top: -7px;"><i class="fa fa-plus"></i> Upload Csv</button></a>
                       </span>
                       <span class="tools pull-right">
