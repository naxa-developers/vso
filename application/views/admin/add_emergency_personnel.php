        ...
        <div class="panel-body">
            <form class="form-horizontal bucket-form" method="post" action="">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-6">
                      <input type="text"  name="address" class="form-control round-input">
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-6">
                      <input type="text"  name="phone_no" class="form-control round-input">
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-6">
                      <input type="text"  name="email" class="form-control round-input">
                  </div>
              </div>
