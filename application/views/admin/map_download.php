        ...
        <div class="col-sm-12">
            <section class="panel">
              <section class="panel">
                ...
                <a href="#"><button type="submit" name="upload_data" class="btn btn-primary"><i class="fa fa-download"></i> Download</button></a>
              </span>
            ...
            echo '<td><button type="button" class="btn btn-round btn-danger" data-toggle="modal" data-target="#myModal'.$v['id'].'"> change  Photo</button></td>';
                            ...
                            <?php }}  ?>
                              <td>
                                ...
                                <a onclick="return confirm('Are you sure you want to delete?')" href="<?php echo base_url()?>delete_map?id=<?php echo $v['id'];?>">Delete</a></td>
